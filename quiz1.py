...
"""
%matplotlib inline
%pylab inline -> ## Runs pandas as pd 
...
fig = plt.figure()  # Names the Scatter Plot as Figure 
plt.subplot(1, 2, 1) # Establishes the size of the subplot
plt.hist(ads.spend)
 
plt.subplot(1, 2, 2) # Establishes the size of the subplot
plt.plt(ads.spend, ads.ctr, 'g.') # Creates a boxplot showing Ad Spend and Ad Counter using Matplotlib style
...
"""
9. What does a Trellis plot allow you to do? # Allows you to group histograms or scatterplots based on a segmentation
What python library does the Trellis plot come from? # Pandas? 
"""
 
 
"""
10. What does the reset_index() function do on a DataFrame? # Allows you to refresh a data frame if you have modified the data set. 
